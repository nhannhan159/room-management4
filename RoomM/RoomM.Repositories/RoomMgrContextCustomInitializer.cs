...
namespace RoomM.Repositories
{
    public class RoomMgrContextCustomInitializer : DropCreateDatabaseAlways<EFDataContext>
    {
        ...
        protected override void Seed(EFDataContext context)
        {
            ...
            var roomTH = new RoomType { Name = "Thuc hanh tin hoc" };
            var roomBi = new RoomType { Name = "Thuc hanh hoa" };
            var roomPy = new RoomType { Name = "Thuc hanh li" };
            var roomLi = new RoomType { Name = "Thuc hanh li thuyet" };
